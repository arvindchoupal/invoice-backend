...
const buildfast_routes_1 = require("./routes/buildfast.routes");
...
const riseguru_routes_1 = require("./routes/riseguru.routes");
const shop_routes_1 = require("./routes/shop.routes");
const retailx_einvoice_routes_1 = require("./routes/retailx-einvoice.routes");
const error_1 = require("./middleware/error");
exports.app = (0, express_1.default)();
exports.app.set("trust proxy", 1); // <-- add this
...
exports.app.use("/api/buildfast", buildfast_routes_1.buildFastRouter);
...
exports.app.use("/api/leads", lead_routes_1.leadRouter);
...
exports.app.use("/api/riseguru", riseguru_routes_1.riseGuruRouter);
exports.app.use("/api/shop", shop_routes_1.shopRouter);
exports.app.use("/api/einvoice", retailx_einvoice_routes_1.retailxEinvoiceRouter);
